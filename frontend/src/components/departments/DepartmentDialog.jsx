...
function DepartmentDialog({
  ...
  const departmentName = values.departmentName ?? values.fullName ?? '';
  const departmentNameError = errors.departmentName ?? errors.fullName ?? '';

  const handleChange = (event) => {
    const nextValue = event.target.value;
    onChange('departmentName', nextValue);
    onChange('fullName', nextValue);
  };
