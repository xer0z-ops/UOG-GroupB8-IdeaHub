...
function ReportsAnonymousIdeasTable({ title, rows = [], onDetail }) {
        ...
        <>
          <TableContainer>
            <Table>
              <TableHead>
                <TableRow>
                  {['Title', 'Department', 'Category', 'Tmb Up/Down/Rep', 'Actions'].map((header) => (
                    <TableCell
                      key={header}
                      sx={{
                        fontWeight: 700,
...
export default ReportsAnonymousIdeasTable;
